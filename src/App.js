...
function App() {
  ...
  return (
    <div className="container-fluid fluid h-100  d-flex flex-column justify-content-between">
      <div className="d-flex align-items-center justify-content-between mt-4">
        <img style={{ width: "210px", height: "39px", objectFit:"cover" }} src={logo} alt="logo" />
          ...
          <div className="dropdown-content">
            <div className={language === "uz" ? "d-none" : ""}>
              <button
                ...
                type="button"
                onClick={() => {setLanguage("uz");changeLanguage("uz")}}
              >
                <img
                  style={{
                    width: "25px",
            ...
            <div className="">
              <button
                onClick={() => {setLanguage("en");changeLanguage("en")}}
                className={
            ...
            <div className="">
              <button
                onClick={() => {setLanguage("ru");changeLanguage("ru")}}
                className={
      ...
      <div className="d-flex align-items-center flex-wrap gap-3 tgPhone">
        <a
      ...
      <Modal
            ...
            footer={null}
          >
            <div className="text-center d-flex gap-4 align-items-center flex-column px-4 h-100">
              <p
